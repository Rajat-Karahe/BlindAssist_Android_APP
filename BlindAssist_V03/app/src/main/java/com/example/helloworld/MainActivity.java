        ...
        detectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                try {
                    ...
                    module = Module.load(fetchModelFile(MainActivity.this, "model.pt"));
                } catch (IOException e) {
                    finish();
                }
                ...
                TextView textView = findViewById(R.id.result_text);
                textView.setText(detected_class + " INR");
                final String toSpeak = "This is a " + detected_class + " rupee note";
